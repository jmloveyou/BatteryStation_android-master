package com.immotor.batterystation.android.mycar.mycarbattery.battery1;
...
public class BatteryOneFragment extends BaseFragment {
    ...
    public int getContentLayout() {
        return R.layout.battery_fragment_one;
    }
    ...
    private void initData() {
        ...
        mData = (BatsBean) bundle.getSerializable(AppConstant.KEY_ENTRY_BATTERY_REQUEST_ONE_DATA);
        if (isEmpty == 1) {
